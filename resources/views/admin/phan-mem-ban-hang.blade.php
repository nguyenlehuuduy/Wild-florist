                ...
                <div class="tile">
                    ...
                    <div class="row">
                        ...
                        <div class="tile-footer col-md-12">
                            ...
                            <a class="btn btn-secondary luu-va-in" href="{{ URL::to('/dashboard') }}">Quay về</a>
                        </div>
                    </div>
                </div>
            </div>
...
-->
    ...
    <script>
        ...
        function time() {
            ...
            tmp = '<span class="date"> <i class="bx bxs-calendar" ></i> ' + today +
                ' | <i class="fa fa-clock-o" aria-hidden="true"></i>  : ' + nowTime +
                '</span>';
