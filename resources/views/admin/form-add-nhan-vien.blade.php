             ...
             <div class="col-md-12">
                 ...
                 <div class="tile">
                     ...
                     <div class="tile-body">
                         ...
                         <form class="row" action="{{ route('nhanvien.store') }}" method="POST">
                             @csrf

                             <div class="form-group col-md-4">
                                 <label class="control-label">ID nhân viên</label>
                                 <input class="form-control" name="IDNV" type="text" placeholder="Nhập ID nhân viên">
                             </div>
                             <div class="form-group col-md-4">
                                 <label class="control-label">Họ và tên</label>
                                 <input class="form-control" name="HoTen" placeholder="Nhập họ tên nhân viên" type="text"
                                     required>
                             </div>
                             <div class="form-group col-md-4">
                             ...
                             <div class="form-group  col-md-3">
                                 ...
                                 <input class="form-control" name="NoiSinh" placeholder="Nhập nơi sinh" type="text"
                                     required>
                             </div>
                             <div class="form-group col-md-3">
                                 <label class="control-label">Số CMND</label>
                                 <input class="form-control" name="SoCMND" placeholder="Nhập số CMND" type="number"
                                     required>
                             </div>
                             <div class="form-group col-md-3">
                                 <label class="control-label">Ngày cấp</label>
                                 <input class="form-control" name="NgayCap" type="date" required>
                             </div>
                             <div class="form-group col-md-3">
                                 <label class="control-label">Nơi cấp</label>
                                 <input class="form-control" name="NoiCap" placeholder="Nhập nơi cấp" type="text"
                                     required>
                             </div>
                             <div class="form-group col-md-3">
                             ...
                             <div class="form-group col-md-3">
                                 ...
                                 <select class="form-control" name="TinhTrangHonNhan" id="exampleSelect2">
