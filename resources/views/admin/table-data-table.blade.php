                    ...
                    <div class="tile-body">
                        ...
                        <div class="row element-button">
                            <div class="col-sm-2">
                                ...
                                <a class="btn btn-add btn-sm" href="{{ URL::to('/form-add-nhan-vien') }}" title="Thêm"><i
                                        class="fas fa-plus"></i>
                                    Tạo mới nhân viên</a>
                            </div>
                            <div class="col-sm-2">
                        ...
                        <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0"
                            ...
                            {{-- <td>{{ $nv->ChucVu }}</td> --}}
                            {{-- <td>{{ $nv->BangCap }}</td>
                                        <td>{{ $nv->TinhTrangHonNhan }}</td> --}}
                            {{-- <td>
                                            <form action="{{ route('nhanvien.destroy', $nv->id) }}" method="POST">
                                                <a href="{{ route('nhanvien.edit', $nv->id) }}"
                            ...
                            {{-- <tbody>
                                <tr>
                                    ...
                                    <td><img class="img-card-person"
                                            src="{{ URL::to('public/backend/img-anhthe/1.jpg') }}" alt=""></td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <a class="btn btn-cancel" data-dismiss="modal" href="{{ URL::to('/table-data-table') }}">Hủy bỏ</a>
                    <BR>
                </div>
